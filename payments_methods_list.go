...
//
// https://docs.cdp.coinbase.com/coinbase-app/trade/reference/retailbrokerageapi_getpaymentmethods
func (s *PaymentMethodsService) List(
	ctx context.Context,
) ([]PaymentMethod, error) {
	...
	if err != nil {
		return nil, fmt.Errorf(
			"failed to fetch all payment methods for the current user: %w",
			err,
		)
	}
